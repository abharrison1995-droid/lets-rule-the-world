...
export function WarConfirmModal({ preview, onConfirm, onCancel }: WarConfirmModalProps) {
  ...
  return (
    <ConfirmModal
      title={`Declare War on ${preview.targetName}?`}
      lead={
      ...
      blockReason={!preview.canDeclare ? preview.blockReason : undefined}
      ...
      fallbackMessage="Limited international backlash expected."
      confirmLabel="Declare War"
      confirmDisabled={!preview.canDeclare}
      onConfirm={onConfirm}
      onCancel={onCancel}
    />
  );
